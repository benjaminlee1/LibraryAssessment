...
The first task is to implement a method that will allow for library fines to be calculated for a collection of books. There are a number of rules that need to be applied to each book for the period of time it is overdue.
The second task is extending the existing web api with a new feature that allows books to be listed grouped by category and display these results using HTML.
...
Steps
1. Use the file ./reactapp/app.js to display the results.
...
To get setup you will need node 10.16+ and npm 5.6+
In poweshell you can type

node -v

to check the version of node and

npm -v

to check the version of npm

To install all of the required packages go to the folder

./LibraryChallengeWeb/reactapp

and run

npm install

Once this is complete, in the same folder you can use

yarn start

this will setup and run a local web server that will show you the starting page

--

Backend / C# rest api
In powershell go to the folder
...
this will start a web server running the web api